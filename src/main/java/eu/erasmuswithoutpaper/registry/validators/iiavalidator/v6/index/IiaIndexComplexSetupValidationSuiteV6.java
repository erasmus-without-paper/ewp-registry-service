...
import eu.erasmuswithoutpaper.registry.validators.types.IiasGetResponseV6;
import eu.erasmuswithoutpaper.registry.validators.types.MobilitySpecificationV6;
...
public class IiaIndexComplexSetupValidationSuiteV6 extends IiaIndexComplexSetupValidationSuiteV2 {

  private static final Logger logger =
      LoggerFactory.getLogger(
          IiaIndexComplexSetupValidationSuiteV6.class);
  ...
  public IiaIndexComplexSetupValidationSuiteV6(
  ...
  protected IiaSuiteState.IiaInfo getIiaInfo(
    ...
    this.setup(new InlineValidationStep() {
      ...
      protected Optional<Response> innerRun() throws Failure {
        ...
        IiasGetResponseV6 getResponse;
        try {
          JAXBContext jaxbContext = JAXBContext.newInstance(IiasGetResponseV6.class);
          Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
          Element xml = makeXmlFromBytes(response.getBody(), true);
          getResponse = (IiasGetResponseV6) unmarshaller.unmarshal(xml);
        ...
        IiasGetResponseV6.Iia iia = getResponse.getIia().get(0);
