...
class OMobilitiesGetSetupValidationSuiteV1
    extends AbstractSetupValidationSuite<OMobilitiesSuiteState> {

  private static final Logger logger =
      LoggerFactory.getLogger(
          OMobilitiesGetSetupValidationSuiteV1.class);
  ...
  OMobilitiesGetSetupValidationSuiteV1(ApiValidator<OMobilitiesSuiteState> validator,
