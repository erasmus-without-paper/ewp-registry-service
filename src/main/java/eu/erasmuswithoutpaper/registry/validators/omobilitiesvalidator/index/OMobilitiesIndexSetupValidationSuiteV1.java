...
class OMobilitiesIndexSetupValidationSuiteV1
    extends AbstractSetupValidationSuite<OMobilitiesSuiteState> {

  private static final Logger logger =
      LoggerFactory.getLogger(
          OMobilitiesIndexSetupValidationSuiteV1.class);
  ...
  OMobilitiesIndexSetupValidationSuiteV1(ApiValidator<OMobilitiesSuiteState> validator,
